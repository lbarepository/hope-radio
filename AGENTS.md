...
> Chaque sous-projet dispose de son propre `AGENTS.md` local pour les détails qui lui sont spécifiques.
> **Ne pas dupliquer ici ce qui est déjà dans `wordpress/AGENTS.md` ou `frontend/AGENTS.md`.**
...
```
/
├── AGENTS.md                  ← ce fichier — vision globale
├── wordpress/
│   ├── AGENTS.md              ← thème, CPT, blocs, plugins, design system
│   └── wp-content/
│       └── themes/
│           └── radio-theme/
└── frontend/
    ├── AGENTS.md              ← Next.js, composants, GraphQL, player, store
    ├── app/
    ├── components/
    ├── graphql/
    └── store/
