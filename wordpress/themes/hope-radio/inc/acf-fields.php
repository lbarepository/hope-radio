...
acf_add_local_field_group([
    ...
    'show_in_graphql'    => 1,
    'graphql_field_name' => 'animateurInfos',
    'fields' => [
        [
        ...
        [
            ...
            'sub_fields' => [
                ...
                [
                    ...
                    'type'              => 'url',
                    'show_in_graphql'   => 1,
                    'graphql_field_name' => 'youtube',
                ],
                [
                    'key'               => 'field_animateur_tiktok',
                    'label'             => 'TikTok',
                    'name'              => 'tiktok',
                    'type'              => 'url',
                    'show_in_graphql'   => 1,
                    'graphql_field_name' => 'tiktok',
                ],
            ],
        ],
    ],
